...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_student'])){
    ...
    if(!$conn){
      die("Connection Problem");
        ...
        $Query = " UPDATE student_db SET   f_name = '$first_name', l_name = '$lasName', m_name = '$middleName' , address = '$address', program = '$program' ,class = '$subject_code' WHERE stdent_ID = $btn_w_id; ";
